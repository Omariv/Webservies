...
/**
 * Class to handle HTTP Multi-part Form Data
 * @author Accenture
 * @version 1.0
 *
 */
public class HTTPMultipartFormData {
     ...
     *
     * @param requestURL URL of the Service
     * @param charset Charset to apply
     * @param headers List of headers
     * @throws IOException Exception to handle Input/Output issue
     */
    public HTTPMultipartFormData(String requestURL, String charset, Map<String, String> headers) throws IOException {
